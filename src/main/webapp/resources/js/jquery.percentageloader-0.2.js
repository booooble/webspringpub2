...
(function() {
    ...
    window.PercentageLoader = function(el, params) {
      var settings, canvas, percentageText, valueText, items, i, item, selectors, s, ctx, progress,
        ...
        outerDiv.style.width = settings.width + '%';
        outerDiv.style.height = settings.height + '%';
        ...
        percentageText.style.width = (settings.width.toString() - 2) + '%';
        ...
        valueText.style.width = (settings.width - 2).toString() + '%';
